...
```bash
sudo ./scripts/08-iso-manager.sh add ubuntu-24.04.3-server.iso
```
...
# 8. Add ISO files
sudo ./08-iso-manager.sh add ubuntu-24.04.3-server.iso
```
...
```bash
sudo ./scripts/08-iso-manager.sh remove ubuntu-24.04.3-server.iso
```
